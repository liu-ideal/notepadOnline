...
<div class="wrap">
  ...
  <div class="wrap_inner">
    ...
    <div class="username">
      <p>Username:</p>
        <input type="text" name="" v-model="username" :placeholder="option.userholder" @keyup="verify(username,password)">
    </div>
    <div class="password">
      <p>Password:</p>
...
.wrap{
  ...
  border: 1px solid rgba(148, 145, 145, 0.8);
  border-radius: 5px;
  color: rgb(60, 60, 60);
  &:hover{
  ...
  .wrap_wrap{
    ...
    background-color: rgba(227, 233, 233, 0.8);
    .wrap_inner{
      width: 350px;
      height: 270px;
      position: absolute;
      ...
      left: 50%;
      transform: translate(-50%,-50%);
      background-color: rgba(231, 240, 240, 0.8);
      ...
      .remenber_submit{
        ...
        .submit{
          ...
          button{
            ...
            line-height: 1;
            border-radius: 10px;
            background-color: rgb(98, 189, 241);
            color: #fff;
            font-weight: bold;
            font-size: 15px;
            cursor: pointer;

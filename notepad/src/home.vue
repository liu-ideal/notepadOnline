  ...
  <div class="wrap">
    ...
    <div class="main">
      <div class="new_build_thing">
        <el-button type="primary" icon="el-icon-edit">新建笔记</el-button>
      </div>
      <div class="thing_list">
        <p v-if='false'>您还没有任何记事，点击上面按钮新建一个吧...</p>
        <ul>
          <li><p>我的第一件记事</p><span><i title="查看笔记" class="iconfont icon-chakan"></i><i class="iconfont icon-xiugai" title="修改笔记"></i><i class="iconfont icon-shanchu" title="删除笔记"></i></span></li>
        </ul>
      </div>
    </div>
<alertContent v-if='toalert' @childValue='childValue'/>
  </div>
</template>
